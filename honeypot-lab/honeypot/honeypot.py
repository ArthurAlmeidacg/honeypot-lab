...
class Honeypot:
    def __init__(self, bind_ip="0.0.0.0", ports=None):   # isso registra o endereco ip e o numero da porta em que sera hospedado
        self.bind_ip = bind_ip 
        self.ports = ports or [21, 22, 80, 443]  # Default ports to monitor
        self.active_connections = {}
        self.log_file = LOG_DIR / f"honeypot_{datetime.datetime.now().strftime('%Y%m%d')}.json"    #caminho para o log

    def log_activity(self, port, remote_ip, data):   #informações sobre o endereço IP, os dados e a porta à qual o IP tentou se conectar. 
        ...
        with open(self.log_file, 'a') as f:    # adiciona essa tentativa em modo json
